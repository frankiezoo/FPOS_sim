...
% CoM=[0,0.00934172358962716,0.00356822089773090]/2';
CoM=[0,0,0]';
...
%initial rotation of the entire body in the float fixed frame
Float_rotation=[0 0 0]';
%mass of entire assembly
Whole_Mass=12.38866; % as we know of 8.11.15

%% Damping terms
%OS body damping terms
OS_damping_trans=0;
OS_damping_rot=0;
phi_0=0*pi/180;
dphi_0=0*pi/180;
...
c_trans=0;%.0177;   %granite friction (translational)
